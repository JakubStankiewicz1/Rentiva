              ...
              <div className="cooperationFormContainerOverlayContainerFormContainer">
                ...
                <div className="cooperationFormContainerOverlayContainerFormContainerTwo">
                  <div className="cooperationFormContainerOverlayContainerFormContainerTwoContainer">
                    ...
                    <p className="cooperationFormContainerOverlayContainerFormContainerTwoContainerText bai-jamjuree-regular">
                      The perfect solution for luxury vehicle owners who want to generate steady rental income without personal involvement. Your car
                      joins the Rentiva fleet, where we provide comprehensive management - from marketing and promotion, through technical service, to
                      full logistics. This allows you to earn passive income while your car works efficiently and safely.
                    </p>
                  </div>
                </div>
                ...
                <div className="cooperationFormContainerOverlayContainerFormContainerThree">
                  <div className="cooperationFormContainerOverlayContainerFormContainerThreeContainer">
                    {" "}
                    <p className="cooperationFormContainerOverlayContainerFormContainerThreeContainerText bai-jamjuree-regular">Contact Us</p>
                  </div>
                </div>
                ...
                <div className="cooperationFormContainerOverlayContainerFormContainerFour">
                  <div className="cooperationFormContainerOverlayContainerFormContainerFourContainer">
                    ...
                    <p className="cooperationFormContainerOverlayContainerFormContainerFourContainerText bai-jamjuree-regular">
                      <span className="cooperationFormContainerOverlayContainerFormContainerFourContainerTextColor bai-jamjuree-regular">
                        Ready to transform your vehicle into a source of income?
                      </span>{" "}
                      Contact our team of experts to learn about cooperation details and join the Rentiva partner community.
                    </p>
                  </div>
                </div>
                ...
                <div className="cooperationFormContainerOverlayContainerFormContainerSeven">
                  <div className="cooperationFormContainerOverlayContainerFormContainerSevenContainer">
                    {" "}
                    <p className="cooperationFormContainerOverlayContainerFormContainerSevenContainerText bai-jamjuree-regular">Fill out the form</p>
                  </div>
                </div>
                  ...
                  <div className="cooperationFormContainerOverlayContainerFormContainerNineContainer">
                    <div className="cooperationFormContainerOverlayContainerFormContainerNineContainerOne">
                      <input
                        ...
                        className="cooperationFormContainerOverlayContainerFormContainerNineContainerOneInput"
                      />
                    </div>
                    ...
                    <div className="cooperationFormContainerOverlayContainerFormContainerNineContainerTwo">
                      <input
                        ...
                        className="cooperationFormContainerOverlayContainerFormContainerNineContainerTwoInput"
                      />
                    </div>
                    ...
                    <div className="cooperationFormContainerOverlayContainerFormContainerNineContainerThree">
                      <input
                        ...
                        className="cooperationFormContainerOverlayContainerFormContainerNineContainerThreeInput"
                      />
                    </div>
                    ...
                    <div className="cooperationFormContainerOverlayContainerFormContainerNineContainerFour">
                      <textarea
                        name=""
                        id=""
                        placeholder="Describe your vehicle and expectations"
                        className="cooperationFormContainerOverlayContainerFormContainerNineContainerFourTextarea"
                      ></textarea>
                    </div>
                    ...
                    <div className="cooperationFormContainerOverlayContainerFormContainerNineContainerSix">
                      ...
                      >
                        <p className="cooperationFormContainerOverlayContainerFormContainerNineContainerSixTwoText bai-jamjuree-regular">
                          I consent to the processing of my personal data by Rentiva Sp. z o.o. for marketing and offer purposes, including through
                          the following communication channels: email, SMS, phone.
                        </p>
                      </div>
                    </div>
                  </div>
